...
const heroSlides = [
  {
    ...
    description:
      "Execution-driven heavy civil programs including bridge works, piling, RCC structures, and large-volume earthwork.",
  },
  {
    title: "Industrial Services",
    image: "/images/pillars/wealth_management.png",
    description:
      "EPC, turnkey design-build, BOP, and subcontracting services for industrial and petrochemical environments.",
  },
  {
    title: "Renewable Energy",
    image: "/images/pillars/renewable_energy.png",
    description:
      "Utility-scale solar execution with full engineering investigations, project control, and 150+ MW installation experience.",
  },
];
...
const Hero = () => {
  ...
  return (
    <section className="relative pt-44 mb-14 overflow-hidden">
      ...
      <div className="mx-auto w-full max-w-[1860px] relative z-1 px-3 md:px-5">
        <div className="grid grid-cols-12 items-center gap-y-10">
          <div className="lg:col-span-6 col-span-12">
            ...
            <h1 className="md:text-56 sm:text-44 text-30 leading-tight text-midnight_text lg:text-start mb-7 lg:w-full w-11/12 font-semibold">
              Safe, quality-first execution for
